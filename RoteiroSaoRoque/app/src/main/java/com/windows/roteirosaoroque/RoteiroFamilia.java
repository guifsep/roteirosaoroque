...
public class RoteiroFamilia extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_roteiro_familia);
        ...
        btnRefazerFamilia.setOnClickListener(new View.OnClickListener() {
            public void onClick (View v) {
                Intent intent = new Intent(RoteiroFamilia.this, Pergunta1.class);
        ...
        btnSairFamilia.setOnClickListener (new View.OnClickListener() {
            public void onClick (View v) {
                Intent intent = new Intent (RoteiroFamilia.this, act_main.class);
                startActivity (intent);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.roteiro_familia, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent(RoteiroFamilia.this, act_comofunciona.class);
            startActivity(intent);
        } else if (id == R.id.nav_quemsomos) {
            Intent intent = new Intent(RoteiroFamilia.this, act_quemsomos.class);
            startActivity(intent);
        }
